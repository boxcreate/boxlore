...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 4 | 143,192 | 4,570 |
|  | `refresh-charts` | 1 | 81,734 | 57,960 |
|  | `sync-episodes` | 4 | 50,693 | 4,500 |
|  | `vectorize-episodes` | 4 | 150,144 | 1,422 |
|  | `vectorize-shows` | 4 | 82,282 | 1,210 |
| | **Day total** | | **508,045** | **69,662** |
