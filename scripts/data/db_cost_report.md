...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 3 | 114,753 | 3,920 |
|  | `refresh-charts` | 1 | 81,565 | 57,474 |
|  | `sync-episodes` | 3 | 50,280 | 3,788 |
|  | `vectorize-episodes` | 3 | 98,567 | 1,833 |
|  | `vectorize-shows` | 3 | 60,337 | 911 |
| | **Day total** | | **405,502** | **67,926** |
