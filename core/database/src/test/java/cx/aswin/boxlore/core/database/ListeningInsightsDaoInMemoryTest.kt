...
class ListeningInsightsDaoInMemoryTest {
    ...
    private fun session(id: String) = ListeningSessionEntity(
        sessionId = id,
        episodeId = "ep-1",
        podcastId = "pod-1",
        startedAt = 1_000L,
    ...
    @Test
    fun rollupIsIdempotentAndMergesIntoExisting() = runTest {
        val today = 200L
    ...
    @Test
    fun samePodcastCanExistInRollupAndTodayRaw() = runTest {
        val today = 50L
    ...
    @Test
    fun deleteEpisodeAndClearAll() = runTest {
