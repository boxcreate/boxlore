...
object GoogleSansTypefaces {
    fun create(context: Context, style: Int = Typeface.NORMAL, roundness: Float = GoogleSansFlexRoundness,): Typeface {
    ...
    fun create(context: Context, weight: Int, italic: Boolean = false, roundness: Float = GoogleSansFlexRoundness,): Typeface = GoogleSansFlexTypeface.create(
        context = context,
        weight = weight,
    ...
    fun cachedRoundness(context: Context): Float = FontRoundnessAxis.cachedAxisValue(context).toFloat()
}
