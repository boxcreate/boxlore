...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 6 | 229,506 | 3,920 |
|  | `refresh-charts` | 3 | 81,565 | 57,474 |
|  | `sync-episodes` | 6 | 50,877 | 4,982 |
|  | `vectorize-episodes` | 6 | 190,901 | 4,305 |
|  | `vectorize-shows` | 6 | 116,119 | 911 |
| | **Day total** | | **668,968** | **71,592** |
