...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 3 | 110,022 | 4,100 |
|  | `refresh-charts` | 1 | 81,230 | 56,504 |
|  | `sync-episodes` | 3 | 50,242 | 3,818 |
|  | `vectorize-episodes` | 3 | 109,647 | 993 |
|  | `vectorize-shows` | 3 | 61,688 | 1,027 |
| | **Day total** | | **412,829** | **66,442** |
