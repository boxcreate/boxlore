...
- Existing coverage includes Learn pagination, Learn deck logic, Explore browse logic, progressive Find-a-show pin-to-top, and shared recommendation cache helpers (`ExploreSharedRecommendationsLogicTest`).
