...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 5 | 187,335 | 3,965 |
|  | `refresh-charts` | 3 | 81,734 | 57,570 |
|  | `sync-episodes` | 5 | 50,581 | 4,500 |
|  | `vectorize-episodes` | 5 | 178,496 | 3,678 |
|  | `vectorize-shows` | 4 | 79,499 | 923 |
| | **Day total** | | **577,645** | **70,636** |
