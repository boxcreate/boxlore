...
object PlaybackControlSync {
     ...
     */
    fun clearedStatePreservingControls(previous: PlayerState, controllerSpeed: Float?,): PlayerState = PlayerState(
     ...
     */
    fun resolvePlaybackSpeed(controllerSpeed: Float?, stateSpeed: Float, fallback: Float = 1.0f,): Float {
     ...
     */
    fun sanitizePlaybackSpeed(speed: Float, fallback: Float = 1.0f, min: Float = 0.5f, max: Float = 3.0f,): Float {
     ...
     */
    fun applyPlaybackParametersSpeed(state: PlayerState, speed: Float,): PlayerState {
     ...
     */
    fun withSyncedPlaybackSpeed(state: PlayerState, controllerSpeed: Float?,): PlayerState = state.copy(
