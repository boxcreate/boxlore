...
- **Merge queue:** expensive unit checks run only in the merge queue (not on every PR push). Resolve SonarCloud + CodeRabbit threads, then **Merge when ready**. See `.github/PULL_REQUEST_TEMPLATE.md`.
