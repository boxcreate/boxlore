...
class FakePortsTest {
    @Test
    fun `FakeLocalCatalogPort stores and links podcasts`() = runTest {
    ...
    @Test
    fun `FakePodcastCatalogPort tracks calls and errors`() = runTest {
    ...
    @Test
    fun `FakeRssSubscriptionPort and ranking reset`() = runTest {
    ...
    @Test
    fun `FakeHistoryRecommendationSource respects limit`() = runTest {
        val source =
    ...
    @Test
    fun `FakeEpisodeOfflineLookup and connectivity`() = runTest {
        val snapshot =
