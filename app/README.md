...
- `NavGraphSettingsDestinations` registers the settings hub, category pages, download settings, and the dedicated `"feedback"` full-page destination wired to `:feature:settings:feedback:FeedbackScreen`.
