...
class EpisodeSupplementRepositoryTest {
    ...
    @Test
    fun `isPublisherFeedUnchanged is false without stored validators`() =
        runTest {
            val dao = FakeDao()
            dao.supplement =
                EpisodeSupplementEntity(
    ...
    @Test
    fun `isPublisherFeedUnchanged is true when HEAD matches`() =
        runTest {
            val dao = FakeDao()
            dao.supplement =
                EpisodeSupplementEntity(
    ...
    @Test
    fun `refreshFromFeed keeps existing rows when loadBaseline throws`() =
        runTest {
            val dao = FakeDao()
            dao.supplement =
                EpisodeSupplementEntity(
