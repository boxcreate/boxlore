...
- `ports.ListeningHistoryBackupPort`, `ports.SmartDownloadSyncPort`, `ports.QueueSyncPort`, and `ports.ActivePlaybackSyncPort` keep backup, download, and playback seams cleanly decoupled without introducing forbidden `:core:catalog` to `:core:playback` dependency cycles.
