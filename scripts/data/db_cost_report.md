...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 4 | 153,004 | 3,920 |
|  | `refresh-charts` | 2 | 81,565 | 57,474 |
|  | `sync-episodes` | 4 | 50,497 | 4,222 |
|  | `vectorize-episodes` | 4 | 129,659 | 2,552 |
|  | `vectorize-shows` | 4 | 78,931 | 911 |
| | **Day total** | | **493,656** | **69,079** |
