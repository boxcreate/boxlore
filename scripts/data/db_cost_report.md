...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 9 | 291,797 | 5,450 |
|  | `refresh-charts` | 6 | 322,049 | 181,157 |
|  | `sync-episodes` | 9 | 244,544 | 2,528 |
|  | `vectorize-episodes` | 9 | 486,259 | 3,053 |
|  | `vectorize-shows` | 6 | 242,013 | 1,767 |
| | **Day total** | | **1,586,662** | **193,955** |
