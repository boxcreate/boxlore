...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 8 | 258,987 | 5,450 |
|  | `refresh-charts` | 6 | 322,049 | 181,157 |
|  | `sync-episodes` | 8 | 244,541 | 2,522 |
|  | `vectorize-episodes` | 8 | 449,207 | 2,834 |
|  | `vectorize-shows` | 5 | 221,922 | 1,767 |
| | **Day total** | | **1,496,706** | **193,730** |
