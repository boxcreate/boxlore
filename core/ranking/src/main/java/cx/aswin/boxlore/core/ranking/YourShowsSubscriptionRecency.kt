...
object YourShowsSubscriptionRecency {
    ...
    fun apply(score: Double, subscribedAt: Long, nowMs: Long,): Double = maxOf(score, floor(subscribedAt, nowMs)).coerceIn(-1.0, 1.0)

    fun floor(subscribedAt: Long, nowMs: Long,): Double {
