...
- `AutoMediaResolver` resolves playable items for Android Auto and sets artist, subtitle, and albumTitle consistently to the podcast title across catalog and API paths.
