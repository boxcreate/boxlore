...
class LibraryBackupImportLogicTest {
    @Test
    fun runRestoreRethrowsCancellation() =
        runTest {
    ...
    @Test
    fun runRestoreReturnsNullForOrdinaryFailure() =
        runTest {
            var logged = false
            val result =
    ...
    @Test
    fun opmlImportCountRethrowsCancellation() =
        runTest {
            assertThrows<CancellationException> {
    ...
    @Test
    fun opmlImportCountReturnsMinusOneForOrdinaryFailure() =
        runTest {
            var logged = false
            val count =
                LibraryBackupImportLogic.opmlImportCount(
