...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 1 | 35,798 | 4,570 |
|  | `refresh-charts` | 1 | 81,734 | 57,960 |
|  | `sync-episodes` | 1 | 50,136 | 3,386 |
|  | `vectorize-episodes` | 1 | 37,701 | 255 |
|  | `vectorize-shows` | 1 | 25,108 | 1,210 |
| | **Day total** | | **230,477** | **67,381** |
