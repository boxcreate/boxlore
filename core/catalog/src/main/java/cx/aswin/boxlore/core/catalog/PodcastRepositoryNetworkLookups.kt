...
internal suspend fun PodcastRepository.searchRssEpisodes(
    feedId: String,
    query: String,
): List<Episode> =
    try {
...
internal suspend fun PodcastRepository.searchNetworkEpisodes(
    feedId: String,
    query: String,
): List<Episode> =
    try {
...
internal suspend fun PodcastRepository.getEpisodesImpl(feedId: String): List<Episode> =
...
internal suspend fun PodcastRepository.getRssEpisodeWindow(
    feedId: String,
...
internal suspend fun PodcastRepository.getNetworkEpisodeWindow(feedId: String): List<Episode> =
    try {
        val resolvedId = resolvePodcastIndexFeedId(feedId)
        val response =
...
internal suspend fun PodcastRepository.getAllRssEpisodes(feedId: String): List<Episode> =
    try {
...
internal suspend fun PodcastRepository.getAllNetworkEpisodes(feedId: String): List<Episode> =
    try {
        val resolvedId = resolvePodcastIndexFeedId(feedId)
...
internal suspend fun PodcastRepository.getEpisodeImpl(episodeId: String): Episode? =
    withContext(Dispatchers.IO) {
...
internal suspend fun PodcastRepository.getRssEpisode(episodeId: String): Episode? =
    try {
...
internal suspend fun PodcastRepository.getSupplementEpisode(episodeId: String): Episode? =
    try {
...
internal suspend fun PodcastRepository.getNetworkEpisode(episodeId: String): Episode? =
    try {
